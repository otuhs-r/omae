class Dashboard
  attr_reader :all_working_seconds, :all_extra_working_seconds, :days_worked_off,
  ...
  def initialize(user, start_date, end_date)
    ...
    @days_worked_off = user.attendances.where(date: start_date..end_date, division: :off_day).count
